...
@section('content')
    ...
    <div class="content ml-3">
        <h1>Creación de un Nuevo Curso</h1>
            ...
            <div class="col-md-12 mt-2">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Llenado de datos de los Cursos</strong></h3>
                    </div>

                    <div class="card-body" style="display:block;">

                       <form action="{{url('/cursos')}}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_curso" class="form-control" value="{{old('nombre_curso')}}">
                                            @error('nombre_curso')
